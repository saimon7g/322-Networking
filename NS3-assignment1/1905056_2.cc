...
NS_LOG_COMPONENT_DEFINE("WirelessMobileNetwork");
...
main(int argc, char* argv[])
{
    ...
    YansWifiChannelHelper channelLeft = YansWifiChannelHelper::Default(); // need to change
...
mobility.SetMobilityModel ("ns3::RandomWalk2dMobilityModel",
                             ...
                             "Speed", StringValue ("ns3::ConstantRandomVariable[Constant="+std::to_string(speedOfNodes)+"]"));
...
// Server side
    ...
    std::string filename1 = "scratch/throughput_2.dat";
    std::string filename2 = "scratch/delivery_ratio_2.dat";
   ...
   std::ofstream outFile1(filename1, std::ios::app);
    ...
    if(variable_param==1){
        ...
        outFile1 << speedOfNodes << " " << throughput << std::endl;
        outFile2 << speedOfNodes << " " << deliveryrate << std::endl;
    }
